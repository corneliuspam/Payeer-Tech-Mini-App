...
<div class="page" id="withdraw">
  <div class="card">
    <h3>💸 Withdrawal</h3>
    <p id="subStatus"></p>
    <input id="amount" placeholder="Minimum ₦5000">
...
<div class="page" id="profile">
  <div class="card">
    ...
    <p>Total Earned: ₦<span id="earned">0</span></p>
  </div>
</div>
...
<script>
const API_URL = "https://payeer-tech-mini-app-production.up.railway.app/api";
...
.then(d=>{
  ...
  subStatus.innerText=d.subscribed
    ? \"Subscription Active ✅\"
    : \"Subscribe ₦2000 before withdrawal\";
});
